...
const btnActionArrow = document.querySelectorAll('.btn-action-arrow');
if (btnActionArrow) {
    btnActionArrow.forEach((btn, index) => {
        btn.addEventListener('click', function (e) {
            e.preventDefault();

            const blocks = document.querySelectorAll('[id^="block-delivery"]');
